...
def preparation_time_in_minutes(number_of_layers):
    """Calculates total preparation time for all layers

    :param number_of_layers: int - number of layers you want to add to the lasagna
    :return: int - time spent on making layers
    """
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    :return: int - the total number of minutes you have been cooking

    This function returns the total number of minutes you have been cooking, 
